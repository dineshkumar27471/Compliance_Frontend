...
export default function CDOStatisticalPrinciplesPage() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="bg-gradient-to-r from-[#1F090D] to-[#330818] px-4 sm:px-6 lg:px-8 py-4 border-b border-white/10">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="hidden lg:flex items-center gap-6">
            <Link href="/entityco/compliance-assessment" className="text-white text-sm hover:text-white/80 transition-colors">
      ...
      <main className="px-4 sm:px-6 lg:px-8 py-6 max-w-7xl mx-auto">
        ...
        <div className="bg-white border border-gray-300 rounded-lg p-4 sm:p-6 mb-6 flex items-center justify-between">
          ...
          <Button className="bg-gray-100 hover:bg-gray-200 text-gray-700 border border-gray-300">Save</Button>
        </div>
