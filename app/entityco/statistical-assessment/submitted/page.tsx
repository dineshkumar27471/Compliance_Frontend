...
export default function CDOStatisticalSubmittedPage() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="px-4 sm:px-6 lg:px-8 py-6 sm:py-8 max-w-7xl mx-auto">
        ...
        <div
          ...
          style={{
            backgroundImage: "url(/images/group-201707480387.png)",
            backgroundSize: "cover",
            backgroundPosition: "center",
          }}
        >
          <div className="relative z-10 p-6 sm:p-8 lg:p-10 bg-gradient-to-br from-[#7A0026]/95 via-[#8B1838]/95 to-[#5A001C]/95">
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="hidden lg:block">{/* Spacer for background image */}</div>
            </div>
