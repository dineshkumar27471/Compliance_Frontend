...
export default function StatisticalSendbackConfirm() {
  ...
  const handleSendBack = () => {
    router.push('/entity_cdo/statistical-sendback-success')
  }
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 relative overflow-hidden min-h-[600px]">
          <div className="relative z-10 max-w-3xl">
            ...
            <div className="mb-8">
              ...
              <div className="border border-gray-300 rounded-lg p-4 min-h-[150px]">
                <p className="text-gray-600 text-sm leading-relaxed">
                  ...
                  1- Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure 
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/entity_cdo/statistical-principles/review">
                <Button variant="outline" className="border-[#7A0026] text-[#7A0026] hover:bg-pink-50 px-6">
                  Back to Compliance Assessment
                </Button>
              </Link>
              <Button 
                onClick={handleSendBack}
                className="bg-[#7A0026] hover:bg-[#5C1F3A] text-white px-8"
              >
                Send Back Questions
              </Button>
            </div>
          ...
          <div className="absolute bottom-0 right-0 opacity-10 pointer-events-none">
            <svg width="400" height="300" viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M300 100l-50 50m0 0l50 50m-50-50h100" stroke="#7A0026" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/>
