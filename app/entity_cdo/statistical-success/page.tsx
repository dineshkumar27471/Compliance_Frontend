...
export default function StatisticalSuccessPage() {
      ...
      <main className="container mx-auto px-4 py-8 sm:py-12 max-w-4xl">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 sm:p-8 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm sm:text-base text-gray-600">
                  Your statistical assessment has been received and is pending approval.
                </p>
              </div>
            </div>
            ...
            <div className="mb-6 space-y-3">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <span className="text-gray-900">Abdullah Sultan</span>
                </div>
              </div>
              <div className="mt-3">
            ...
            {/* Done Button */}
            <Button 
              onClick={() => router.push('/entity_cdo/statistical-assessment/submitted')}
