...
import { Eye, Menu, X, CheckCircle2, ChevronRight } from 'lucide-react'
import { Button } from '@/components/ui/button'

export default function AuditorComplianceAssessmentSubmitted() {
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6">
              <Link href="/entity_cdo/ComplianceAssessment" className="text-sm hover:text-gray-300 transition-colors whitespace-nowrap border-b-2 border-white">
          ...
          {mobileMenuOpen && (
            <nav className="md:hidden mt-4 pb-4 border-t border-white/20 pt-4">
              <div className="flex flex-col gap-3">
                <Link href="/entity_cdo/ComplianceAssessment" className="text-sm hover:text-gray-300 transition-colors break-words border-b border-white pb-1">
                  Compliance Assessment
                </Link>
        ...
        <div className="relative bg-gradient-to-r from-[#7A0026] to-[#5C1F3A] rounded-2xl p-6 sm:p-8 md:p-12 mb-8 overflow-hidden">
          <div className="relative z-10 max-w-3xl">
            ...
            <div className="flex items-start gap-4 mb-6">
              <div className="w-12 h-12 bg-green-500 rounded-full flex items-center justify-center flex-shrink-0 shadow-lg border-2 border-white/20">
              ...
              <div className="space-y-1">
                ...
                <p className="text-white/90 text-sm">
                  <span className="font-medium">Submitted By:</span> Ahmad OWC
                </p>
              </div>
            </div>
            ...
            <p className="text-white/80 text-sm leading-relaxed max-w-2xl">
              NPC will take up to two months to thoroughly review your submission. During this time, they will analyze your responses, identify any gaps, and develop a tailored compliance plan with actionable recommendations to help your organization align with the required standards.
            </p>
          </div>
            ...
            <div className="grid gap-4">
              {domainScores.map((domain) => (
                <div key={domain.id} className="flex items-center gap-4">
                  ...
                  <div className={`w-12 h-8 ${domain.color} text-white rounded flex items-center justify-center text-sm font-bold flex-shrink-0`}>
                    {domain.score}
                  </div>
                  <div className="w-24 sm:w-48 h-8 bg-gray-100 rounded-full overflow-hidden hidden sm:block">
                    <div 
                      className={`h-full ${domain.color.replace('bg-', 'bg-opacity-50 ')}`} 
